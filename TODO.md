...
* [ ] 駅規模特徴量を入れる場合も `station` カテゴリは残し、駅名固有の地価・沿線・立地情報を落とさない構成で再学習する
* [ ] `2005-2025` と `2015-2025` の学習期間を比較し、近年データに絞った方が駅規模・商業施設・再開発影響を拾いやすいか検証する
* [ ] 首都圏4県で `station` + 駅規模特徴量の組み合わせを先に比較し、MAE/RMSE/MAPEとONNXサイズの変化を記録する

### P2 モデル比較と採用判断

* [ ] 商業施設特徴量をハザード特徴量と組み合わせる比較時に再評価する
* [ ] 商業施設特徴量はまず首都圏4県に限定して、駅規模特徴量と同時投入/単独投入の差を比較する
* [ ] ハザード特徴量は商業施設特徴量の比較後に追加し、精度改善よりもリスク説明力・表示価値も含めて採用判断する
* [ ] `has_station_passenger_data` のように重要度がほぼ出ないフラグ特徴量は、削除候補として比較する
