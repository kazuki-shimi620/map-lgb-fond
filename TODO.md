...
* [ ] モデル、駅マスタ、価格推論失敗時のエラー表示テストを追加する
* [ ] GitHub ActionsでChromiumのE2Eテストを実行する
* [ ] PlaywrightのHTMLレポート、trace、動画、失敗時スクリーンショットをCI artifactに保存する
...
* [ ] READMEにREADME用スクリーンショット生成方法を追加する
* [ ] READMEの技術構成へPlaywrightを追加する
* [ ] READMEの注意事項を末尾に整理する
* [ ] README内の画像リンクがGitHub上で表示できることを確認する
