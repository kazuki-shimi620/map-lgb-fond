...
refresh-input-ranges:
	cd $(TRAINING_DIR) && $(TRAINING_PYTHON) -m src.export.input_ranges \
		--processed-dir data/processed \
		--public-dir ../$(FRONTEND_DIR)/public
